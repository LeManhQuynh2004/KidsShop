...
public class CartItem_Payment_Adapter extends BaseAdapter {
    Context context;
    ArrayList<CartItem> list;
    ProductDao productDao;

    public CartItem_Payment_Adapter(Context context, ArrayList<CartItem> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(cartItem != null){
            ...
            cartViewHolder.tv_quantity.setText("x"+cartItem.getQuantity());
        }
        return view;
    }
}
